import{Q as M,R as L}from"./vendor.41b27b13.js";class S{constructor(t=[],n=I){if(this.data=t,this.length=this.data.length,this.compare=n,this.length>0)for(let i=(this.length>>1)-1;i>=0;i--)this._down(i)}push(t){this.data.push(t),this.length++,this._up(this.length-1)}pop(){if(this.length===0)return;const t=this.data[0],n=this.data.pop();return this.length--,this.length>0&&(this.data[0]=n,this._down(0)),t}peek(){return this.data[0]}_up(t){const{data:n,compare:i}=this,r=n[t];for(;t>0;){const c=t-1>>1,l=n[c];if(i(r,l)>=0)break;n[t]=l,t=c}n[t]=r}_down(t){const{data:n,compare:i}=this,r=this.length>>1,c=n[t];for(;t<r;){let l=(t<<1)+1,h=n[l];const p=l+1;if(p<this.length&&i(n[p],h)<0&&(l=p,h=n[p]),i(h,c)>=0)break;n[t]=h,t=l}n[t]=c}}function I(e,t){return e<t?-1:e>t?1:0}function m(e,t){return e.p.x>t.p.x?1:e.p.x<t.p.x?-1:e.p.y!==t.p.y?e.p.y>t.p.y?1:-1:1}function P(e,t){return e.rightSweepEvent.p.x>t.rightSweepEvent.p.x?1:e.rightSweepEvent.p.x<t.rightSweepEvent.p.x?-1:e.rightSweepEvent.p.y!==t.rightSweepEvent.p.y?e.rightSweepEvent.p.y<t.rightSweepEvent.p.y?1:-1:1}class y{constructor(t,n,i,r){this.p={x:t[0],y:t[1]},this.featureId=n,this.ringId=i,this.eventId=r,this.otherEvent=null,this.isLeftEndpoint=null}isSamePoint(t){return this.p.x===t.p.x&&this.p.y===t.p.y}}function F(e,t){if(e.type==="FeatureCollection"){const n=e.features;for(let i=0;i<n.length;i++)g(n[i],t)}else g(e,t)}let a=0,u=0,d=0;function g(e,t){const n=e.type==="Feature"?e.geometry:e;let i=n.coordinates;(n.type==="Polygon"||n.type==="MultiLineString")&&(i=[i]),n.type==="LineString"&&(i=[[i]]);for(let r=0;r<i.length;r++)for(let c=0;c<i[r].length;c++){let l=i[r][c][0],h=null;u=u+1;for(let p=0;p<i[r][c].length-1;p++){h=i[r][c][p+1];const o=new y(l,a,u,d),s=new y(h,a,u,d+1);o.otherEvent=s,s.otherEvent=o,m(o,s)>0?(s.isLeftEndpoint=!0,o.isLeftEndpoint=!1):(o.isLeftEndpoint=!0,s.isLeftEndpoint=!1),t.push(o),t.push(s),l=h,d=d+1}}a=a+1}class b{constructor(t){this.leftSweepEvent=t,this.rightSweepEvent=t.otherEvent}}function k(e,t){if(e===null||t===null||e.leftSweepEvent.ringId===t.leftSweepEvent.ringId&&(e.rightSweepEvent.isSamePoint(t.leftSweepEvent)||e.rightSweepEvent.isSamePoint(t.leftSweepEvent)||e.rightSweepEvent.isSamePoint(t.rightSweepEvent)||e.leftSweepEvent.isSamePoint(t.leftSweepEvent)||e.leftSweepEvent.isSamePoint(t.rightSweepEvent)))return!1;const n=e.leftSweepEvent.p.x,i=e.leftSweepEvent.p.y,r=e.rightSweepEvent.p.x,c=e.rightSweepEvent.p.y,l=t.leftSweepEvent.p.x,h=t.leftSweepEvent.p.y,p=t.rightSweepEvent.p.x,o=t.rightSweepEvent.p.y,s=(o-h)*(r-n)-(p-l)*(c-i),E=(p-l)*(i-h)-(o-h)*(n-l),w=(r-n)*(i-h)-(c-i)*(n-l);if(s===0)return E===0&&w===0,!1;const f=E/s,v=w/s;if(f>=0&&f<=1&&v>=0&&v<=1){const x=n+f*(r-n),z=i+f*(c-i);return[x,z]}return!1}function _(e,t){t=t||!1;const n=[],i=new S([],P);for(;e.length;){const r=e.pop();if(r.isLeftEndpoint){const c=new b(r);for(let l=0;l<i.data.length;l++){const h=i.data[l];if(t&&h.leftSweepEvent.featureId===r.featureId)continue;const p=k(c,h);p!==!1&&n.push(p)}i.push(c)}else r.isLeftEndpoint===!1&&i.pop()}return n}function A(e,t){const n=new S([],m);return F(e,n),_(n,t)}const B={viewbox:"0, 0, 300, 468",content:`<g transform="translate(0.000000,468.000000) scale(0.100000,-0.100000)"
